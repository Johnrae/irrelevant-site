 ...
 */
export type BandDocument<Lang extends string = string> =
  prismicT.PrismicDocumentWithUID<Simplify<BandDocumentData>, 'band', Lang>
 ...
 *
 */
type ConsultingProjectDocumentDataSlicesSlice =
  | ImageGallerySlice
  | BasicContentSlice
/**
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type ConsultingProjectDocument<Lang extends string = string> =
  prismicT.PrismicDocumentWithUID<
    Simplify<ConsultingProjectDocumentData>,
    'consulting-project',
    Lang
  >
 ...
 *
 */
export type BasicContentSliceDefault = prismicT.SharedSliceVariation<
  'default',
 ...
 *
 */
export type BasicContentSlice = prismicT.SharedSlice<
  'basic_content',
 ...
 *
 */
export type ImageGallerySliceDefault = prismicT.SharedSliceVariation<
  'default',
  Record<string, never>,
 ...
 *
 */
export type ImageGallerySlice = prismicT.SharedSlice<
  'image_gallery',
...
declare module '@prismicio/client' {
  ...
  namespace Content {
    export type {
      BandDocumentData,
      BandDocumentDataLinksItem,
      BandDocumentDataAgentItem,
      BandDocumentDataSlicesSlice,
      BandDocument,
      ConsultingProjectDocumentData,
      ConsultingProjectDocumentDataSlicesSlice,
      ConsultingProjectDocument,
      EventDocumentData,
      EventDocumentDataSocialLinksItem,
      EventDocumentDataBandsItem,
